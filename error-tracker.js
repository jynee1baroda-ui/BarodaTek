...
class ErrorTracker {
    ...
    async processQueue() {
        ...
        try {
            // Only try to send to server if API endpoint exists
            // Silent fail for static site deployments
            ...
            // Silently store in localStorage - don't spam console with warnings
            // Only warn in development mode
            if (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') {
                console.warn('Error logging to server unavailable (static mode) - storing locally');
            }
